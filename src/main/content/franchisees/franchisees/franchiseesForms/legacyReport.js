...
//Child components
import SummaryTransactons from "./legacyReports/summaryTransactions";
import CustomerTransactions from './legacyReports/customerTransactions'
import CustomerAccountTotals from './legacyReports/customerAccountTotal'
import SupplyTransactons from './legacyReports/supplyTransactions'
import RegularMiscTransactions from './legacyReports/regularMiscTransactions'
import SpecialMiscTransactions from './legacyReports/specialMiscTransactions'
import FindersFeeTransactions from './legacyReports/findersFeeTransactions'
import ChargeBacksTransactions from './legacyReports/chargeBacksTransactions'
...
export default  withStyles(styles)(withRouter(connect(mapStateToProps, mapDispatchToProps)(LegacyReport)));
