...
import ReportCus from './reportCus';
...
class ReportCusLayout extends Component {
    constructor(props) {
        super(props);
                        ...
                        <div className="flex-1 flex-col absolute w-full h-full">
                            <Fragment>
                                <div id ="franchiseesprint">
                                    <ReportCus onRef={ref => (this.child = ref)}/>
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(ReportCusLayout)));
