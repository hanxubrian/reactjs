...
class LeaseSearchBar extends Component {
		...
		return (
			<div className="flex flex-row items-center">
				...
				{/* <div className="flex items-center justify-end p-12">
					<Button
						onClick={this.props.toggleSummaryPanelLeases}
...
function mapStateToProps({ leases }) {
	return {
		bOpenedFilterPanel: leases.bOpenedFilterPanel,
...
export default withStyles(styles, { withTheme: true })(withRouter(connect(mapStateToProps, mapDispatchToProps)(LeaseSearchBar)));
