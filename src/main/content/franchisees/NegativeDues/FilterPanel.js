...
class FilterPanel extends Component {
    ...
    componentWillMount(){
        this.setState({
           findersFeeStatus: this.props.findersFeeStatus
        });
    }
    ...
    handleChange = (index,name) => event => {
        ...
        const iStatus = this.props.findersFeeStatus;
        iStatus[index][name] = event.target.checked;

        this.setState({findersFeeStatus: iStatus });
        // this.props.updateFindersFeeStatus(iStatus)
    };
    ...
    render()
    {
        const {classes, findersFeesForm} = this.props;
        const stateNames = [
            {
                value: 2,
                label: "Buffalo"
            ...
            <div className={classNames(classes.root)}>
                <div className={classNames("flex flex-col")}>
                    <Paper className="flex flex-1 flex-col min-h-px p-20">
                        {findersFeesForm && findersFeesForm.props.open
                        ?(
                           <div>
                           ...
                           <div style={{display: 'flex', flexDirection: 'column'}}>
                                ...
                                <br/>
                                <h3>FindersFees Statuses</h3>
                               { this.props.findersFeeStatus && this.props.bLoadedFilterList && (
                                   <FormControl>
                                       {
                                           this.props.findersFeeStatus.map((data,index)=>(
                                               <FormControlLabel
                                                   key={data.Value}
                                                   control={
                                                       <Switch
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        ...
        // updateFindersFeeStatus: Actions.updateFindersFeeStatus
    }, dispatch);
}
...
{
    return {
        filterStateFindersFees: findersFees.bOpenedSummaryPanelFindersFees,
        transactionStatusFindersFees: findersFees.transactionStatusFindersFees,
        findersFeesForm: findersFees.createFindersFees,
        Location: findersFees.Location,
        bLoadedFilterList: findersFees.bLoadedFilterList,
        regionId: auth.login.defaultRegionId,
        findersFeeStatus: findersFees.findersFeeStatus
    }
}
