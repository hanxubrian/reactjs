...
function createData( documentName = '', uploadDateTime='', browse = '') {
    return {
        id: counter++,
        // docType,
        documentName,
...
class CustomerLineTableHead extends React.Component {
    ...
    render() {
        const { order, orderBy, headers, documents } = this.props;
        let rows = headers;
...
class CustomersDocumentUploadTable extends React.Component {
    state = {
        order: 'asc',
        selected: [],
        page: 0,
    ...
    render() {
        ...
        console.log(this.props.documents.Data)
        return (
...
CustomersDocumentUploadTable.propTypes = {
    classes: PropTypes.object.isRequired
};

export default withStyles(styles)(CustomersDocumentUploadTable);
