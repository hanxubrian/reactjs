...
class InvoiceReport extends Component {
	...
	render() {
		...
		return (
			...
			>
				{/* <DialogTitle id="form-dialog-title">Invoice Detail</DialogTitle> */}
				<DialogContent>
						...
						<table style={{ width: '100%', borderCollapse: 'collapse', border: 'solid 1px' }}>
							<tbody>
								...
								<tr>
									<td width="10%" style={{ borderRight: 'solid 1px' }} className="text-center"></td>
									<td width="60%" className="text-center">
										<Typography><strong style={{ fontSize: '11px', color: 'black' }}>Make All Checks Payable To:</strong></Typography>
										<Typography><strong style={{ fontSize: '11px', color: 'black' }}>JANI-KING OF
