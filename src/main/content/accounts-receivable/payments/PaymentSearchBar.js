...
class PaymentSearchBar extends Component {
		...
		return (
			<div className="flex flex-row items-center">
				<div className="flex items-center justify-start p-12">
					<Button
						onClick={this.props.toggleFilterPanelAccountReceivablePayments}
...
function mapDispatchToProps(dispatch) {
	return bindActionCreators({
		toggleFilterPanelAccountReceivablePayments: Actions.toggleFilterPanelAccountReceivablePayments,
		toggleSummaryPanelAccountReceivablePayments: Actions.toggleSummaryPanelAccountReceivablePayments,
...
function mapStateToProps({ accountReceivablePayments }) {
	return {
		bOpenedFilterPanel: accountReceivablePayments.bOpenedFilterPanel,
...
export default withStyles(styles, { withTheme: true })(withRouter(connect(mapStateToProps, mapDispatchToProps)(PaymentSearchBar)));
