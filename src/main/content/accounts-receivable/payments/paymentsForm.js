...
import InvoiceLineTable from "./paymentsLine"
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(PaymentsForm)));
