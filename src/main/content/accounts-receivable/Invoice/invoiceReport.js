    ...
    render()
    {
        ...
        return (
                    <div onClick={this.props.onClose}  className="backdrop" style={{position: 'absolute',
                        ...
                        padding: 50}}>
                        <div onClick={this.props.onClose} className="modal" style={{ backgroundColor: '#fff',
                            borderRadius: 5,
                            maxWidth: '80%',
                            minHeight: 300,
                            margin: '0 auto',
                            ...
                            <div style={{width: '100%'}}>
                                ...
                                <table style={{width:'85%'}} align="center">
                                    ...
                                    <tr>
                                        <td width='60%' className="text-left">
                                            <Typography><span>{this.state.CustomerSoldTo.AddressLine1}</span><span style={{paddingLeft:100}}>{this.state.CustomerSoldTo.State}</span><span style={{paddingLeft:30}}>{this.state.CustomerSoldTo.ZipCode}</span></Typography>
                                        </td>
                                        <td width='40%' className="text-left">
                                            <Typography><span>{this.state.CustomerFor.AddressLine1}</span><span style={{paddingLeft:100}}>{this.state.CustomerFor.State}</span><span style={{paddingLeft:30}}>{this.state.CustomerFor.ZipCode}</span></Typography>
                                        </td>
                                    </tr>
                                    </tbody>
