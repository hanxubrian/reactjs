...
class FranchiseeAboutTab extends Component {
                            ...
                            <Card className="w-full mb-16">
                                ...
                                <CardContent>
                                    ...
                                    <div className="mb-24">
                                        ...
                                        <Typography>220 Reviews</Typography>
                                    </div>
...
function mapStateToProps({auth, usersApp})
{
    return {
        login: auth.login,
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(FranchiseeAboutTab)));
// export default withStyles(styles, {withTheme: true})(FranchiseeAboutTab);
