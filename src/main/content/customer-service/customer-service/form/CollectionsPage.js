...
// core components
import { IconButton, Input, Button, CircularProgress, Typography } from '@material-ui/core';
...
class CollectionsPage extends Component {
	...
	initRowsFromRawJson = (rawData = this.props.customerServiceForm.collectionList.data) => {
...
function mapDispatchToProps(dispatch) {
	return bindActionCreators({
		...
		getCustomerCollectionList: Actions.getCustomerCollectionList,
...
export default withStyles(styles, { withTheme: true })(withRouter(connect(mapStateToProps, mapDispatchToProps)(CollectionsPage)));
