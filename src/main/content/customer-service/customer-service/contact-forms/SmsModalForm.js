...
class SmsModalForm extends React.Component {
	...
	handleClose = () => {
		...
		this.props.showSendSmsModalForm(false)
...
export default withStyles(styles, { withTheme: true })(withRouter(connect(mapStateToProps, mapDispatchToProps)(SmsModalForm)));