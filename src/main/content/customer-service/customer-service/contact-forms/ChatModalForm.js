...
class ChatModalForm extends React.Component {
	...
	handleClose = () => {
		...
		this.props.showSendChatModalForm(false)
				...
				>
					<BlueDialogTitle id="form-dialog-title" onClose={this.handleClose}>
						<h2 style={{ display: "flex", alignItems: "center", color: "white" }}>
							<Icon>chat_bubble_outline</Icon>&nbsp;&nbsp;Send Chat</h2>
					</BlueDialogTitle>
					<DialogContent>
...
export default withStyles(styles, { withTheme: true })(withRouter(connect(mapStateToProps, mapDispatchToProps)(ChatModalForm)));