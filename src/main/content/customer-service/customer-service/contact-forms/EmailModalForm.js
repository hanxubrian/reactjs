...
class EmailModalForm extends React.Component {
	...
	handleClose = () => {
		...
		this.props.showSendEmailModalForm(false)
	...
	render() {
		...
		return (
			<div>
				<Dialog
					open={this.props.contactForms.emailModalForm.open === true}
					fullWidth={true}
					maxWidth="sm"
				...
				>
					<BlueDialogTitle id="form-dialog-title" onClose={this.handleClose}>
						<h2 style={{ display: "flex", alignItems: "center", color: "white" }}>
							<Icon>email_outline</Icon>&nbsp;&nbsp;Send Email</h2>
					</BlueDialogTitle>
					<DialogContent>
...
export default withStyles(styles, { withTheme: true })(withRouter(connect(mapStateToProps, mapDispatchToProps)(EmailModalForm)));