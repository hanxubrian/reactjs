...
class CustomerLists extends Component {
    ...
    processData = ()=> {
        if(this.props.verifications!==null) {
            let temp = [...this.props.verifications.Data.Customers];
    ...
    render() {
        ...
        let  columns= [
            ...
            { title: "Contract",    name: "ContBill"},
            { title: "Address",     name: "CustAddress"},
            { title: "City",        name: "CustCity"},
            { title: "State",       name: "CustState"},
            { title: "Phone",       name: "CustPhone"},
        ...
        let  tableColumnExtensions = [
            { columnName: "CustAddress",    wordWrapEnabled: true, width: 200},
            { columnName: "CustomerName",   width: -1 },
            { columnName: "ContBill",       width: 120, align: 'right'},
            { columnName: "Phone",          width: 140, align: 'right'},
...
export default withStyles(styles, { withTheme: true })(withRouter(connect(mapStateToProps, mapDispatchToProps)(CustomerLists)));
