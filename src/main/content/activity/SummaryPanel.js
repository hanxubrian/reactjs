...
class SummaryPanel extends Component {
    ...
    render() {
        ...
        // const { classes, toggleFilterPanel, toggleSummaryPanel, filterState, summaryState, deleteCustomersAction, openNewCustomerForm, verificationForm } = this.props;
        let widgets_data = {
            widget8: {
                datasets: [
                    [
                ...
                <div className={classNames("flex flex-col p-16")}>
                    {this.props.verifications && (
                        <Paper className="flex flex-1 flex-col min-h-px shadow-none" style={{ alignItems: 'center', flexDirection: 'column' }}>
                            ...
                            {verificationForm && verificationForm.props.open
                                ? (
