...
class LeadLineTableHead extends React.Component {
...
let LeadLineTableToolbar = props => {
...
LeadLineTableToolbar.propTypes = {
	classes: PropTypes.object.isRequired,
	numSelected: PropTypes.number.isRequired
};

LeadLineTableToolbar = withStyles(toolbarStyles)(LeadLineTableToolbar);
...
class LeadLineTable extends React.Component {
	state = {
		order: 'asc',
		// orderBy    : 'billing',
		selected: [],
		data: [
			createData("Regular Billing", "Adjust-Balance", "Lead", 1),
		],
		page: 0,
		rowsPerPage: 10,
		labelWidth: 0,
			...
			<Paper className={classes.root}>
				<div className={classes.tableWrapper}>
					<Table className={classes.table} aria-labelledby="tableTitle">
						<LeadLineTableHead
							className={classNames(classes.LeadLineHeadRoot)}
											...
											<TableCell>
												{/* <FormControl variant="outlined" className={classes.formControl} style={{ marginBottom: '0!important' }}>
													...
													>
														...
														<MenuItem value="Lead Suppliers">Lead Suppliers</MenuItem>
...
LeadLineTable.propTypes = {
	classes: PropTypes.object.isRequired
};

export default withStyles(styles)(LeadLineTable);
