        ...
        return (
            <div className="w-full">
                ...
                <div className="max-w-2xl w-full mx-auto px-8 sm:px-16 py-24">
                    <div className="flex flex-col sm:flex-row items-center justify-between py-24" style={{display:'none'}}>
                        <TextField
                                ...
                                <div className="w-full pb-24 sm:w-1/2 lg:w-1/3 sm:p-16" key={course.id}>
                                    <Card elevation={1} className="flex flex-col h-256">
                                        ...
                                        <CardContent className="flex flex-col flex-auto items-center justify-center">
                                            <Typography className="text-center text-16 font-400"></Typography>
                                            <Typography className="text-center text-13 font-600 mt-4" color="textSecondary"></Typography>
                                        </CardContent>
                                        <Divider/>
...
function mapStateToProps({academyApp,auth})
{
    return {
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(Courses)));
