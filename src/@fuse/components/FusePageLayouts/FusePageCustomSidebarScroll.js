...
class FusePageCustomSidebarScroll extends React.Component {
	state = {
		leftSidebar: false,
		rightSidebar: false
	};
...
FusePageCustomSidebarScroll.propTypes = propTypes;
FusePageCustomSidebarScroll.defaultProps = defaultProps;

export default withStyles(styles, { withTheme: true })(FusePageCustomSidebarScroll);
