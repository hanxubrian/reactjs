...
class FusePageCustom extends React.Component {
    state = {
        leftSidebar : false,
        rightSidebar: false
    };
...
FusePageCustom.propTypes = propTypes;
FusePageCustom.defaultProps = defaultProps;

export default withStyles(styles, {withTheme: true})(FusePageCustom);
