...
class FusePageUsersCustom extends React.Component {
    state = {
        leftSidebar : false,
        rightSidebar: false
    };
...
FusePageUsersCustom.propTypes = propTypes;
FusePageUsersCustom.defaultProps = defaultProps;

export default withStyles(styles, {withTheme: true})(FusePageUsersCustom);
